...
//
// /// <summary>
// /// Implements a Roslyn code fix provider that adds a registration for each type that implements `IWorkflow`
// /// but which isn't also registered within the `AddDaprWorkflow` dependency injection registration. 
// /// </summary>
// [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(CSharpWorkflowDependencyInjectionAnalyzerCodeFixProvider))]
// public sealed class CSharpWorkflowDependencyInjectionAnalyzerCodeFixProvider : CodeFixProvider
// {
// 	//Specify the diagnostic IDs of analyzers that are expected to be linked
//     /// <inheritdoc/>
// 	public sealed override ImmutableArray<string> FixableDiagnosticIds =>
// 		ImmutableArray.Create(CSharpWorkflowDependencyInjectionValidationAnalyzer.DiagnosticId);
//
//     /// <inheritdoc/>
...
// 				CodeAction.Create(title: Resources.WF0001CodeFixTitle,
// 					createChangedDocument: c => RegisterWorkflowAsync(context.Document, declaration, c),
// 					equivalenceKey: Resources.WF0001CodeFixTitle), diagnostic);
// 		}
// 	}
//
// 	private async Task<Document> RegisterWorkflowAsync(Document document, TypeDeclarationSyntax typeDecl,
...
// 		var workflowType = semanticModel.Compilation.GetTypeByMetadataName("IWorkflow");
// 		
...
// 		const string methodName = "RegisterWorkflow";
//
